...
export class StylePaginatorDirective {
  ...
  private _showPaginatorRange: boolean = false;
  private _pageGapTxt = "...";
  ...
  @Input()
  get showPaginatorRange(): boolean {
    return this._showPaginatorRange;
  }

  set showPaginatorRange(value: boolean)  {
    this._showPaginatorRange = value;
  }
  ...
  private initShowPaginatorRange(){
    if(!this._showPaginatorRange){
      const paginationRange = this.vr.element.nativeElement.querySelector("div.mat-mdc-paginator-range-label");
      if(paginationRange) paginationRange.remove();
      console.log("this.showPaginatorRange", paginationRange);
  ...
  private buildPageNumbers() {
    ...
    this.ren.setStyle(actionContainer, "justify-content", "center");

    //initialize next page and last page buttons
    if (this._buttons.length == 0) {

      let nodeArray = this.vr.element.nativeElement.childNodes[0].childNodes[0].childNodes[1].childNodes;
        ...
        for (let i = 0; i < nodeArray.length; i++) {
          if (nodeArray[i].nodeName === "BUTTON") {
            ...
            if (nodeArray[i].innerHTML.length > 100 && nodeArray[i].disabled) {
                //this.ren.setStyle(nodeArray[i], "background-color", "#E3E4E8");
                ...
                //this.ren.setStyle(nodeArray[i], "background-color", "#00AE9D");
                //this.ren.setStyle(nodeArray[i], "color", "white");
                this.ren.setStyle(nodeArray[i], "margin", ".5%");
                //this.ren.addClass(nodeArray[i], "mat-mdc-icon-button");
            ...
            //this.ren.addClass(nodeArray[i], "mdc-icon-button");
            //this.ren.addClass(nodeArray[i], "mat-mdc-icon-button");
            this.ren.addClass(nodeArray[i], "mat-unthemed");
            //this.ren.addClass(nodeArray[i], "mat-mdc-button-base");

            this.ren.addClass(nodeArray[i], "mdc-fab");
            this.ren.addClass(nodeArray[i], "mdc-fab--mini");
            // this.ren.addClass(nodeArray[i], "mat-mdc-mini-fab");
            // this.ren.addClass(nodeArray[i], "mat-primary");
            // this.ren.removeClass(nodeArray[i], "mat-mdc-button-base");

            let icone = nodeArray[i].getElementsByClassName("mat-mdc-paginator-icon");
            //if(icone.item(0) && icone.item(0).classList)
              //icone.item(0).classList.remove("mat-mdc-paginator-icon");
  ...
  private createButton(i: any, pageIndex: number): any {
    ...
    this.ren.addClass(linkBtn, "mdc-fab");
    this.ren.addClass(linkBtn, "mdc-fab--mini");
    this.ren.addClass(linkBtn, "box-shadow-nome");
    this.ren.addClass(linkBtn, "mat-mdc-mini-fab");
    this.ren.addClass(linkBtn, "mat-basic-cloud");
    ...
    switch (i) {
      case pageIndex:
        ...
        this.ren.addClass(linkBtn, "mat-mdc-fab");
        this.ren.addClass(linkBtn, "mat-primary");
        this.ren.addClass(linkBtn, "color-white");
        this.ren.removeClass(linkBtn, "mat-basic-cloud");
        break;
  ...
  private initPageRange(): void {
    ...
    console.log('_showPaginatorRange');
    this.initShowPaginatorRange();
  }
